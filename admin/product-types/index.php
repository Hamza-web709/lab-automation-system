...
<div class="page-header" data-animate="fade-up">
    <div>
        ...
        <h2>Product Types</h2>
        <p>Maintain the product families used when generating product IDs.</p>
    </div>
    <a class="btn btn-primary" href="<?= url('admin/product-types/create.php') ?>"><i data-lucide="plus"></i> Add Type</a>
</div>
...
<form class="filter-bar surface-card" method="get" data-animate="fade-up">
    ...
    <a class="btn btn-soft" href="<?= url('admin/product-types/index.php') ?>"><i data-lucide="rotate-ccw"></i> Reset</a>
</form>
...
<section class="surface-card table-shell" data-animate="fade-up">
                    ...
                    <tr data-search-row>
                        ...
                        <td>
                            <div class="table-actions">
                                <a class="icon-btn" href="<?= url('admin/product-types/edit.php?id=' . (int) $row['id']) ?>" aria-label="Edit"><i data-lucide="pencil"></i></a>
                                <form method="post" action="<?= url('admin/product-types/delete.php') ?>" onsubmit="return confirm('Delete this product type?');">
                                    <?= csrf_field() ?>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p>Add the first product type to begin registering manufactured items.</p>
        </div>
    <?php endif; ?>
</section>
